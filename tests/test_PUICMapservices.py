...
class Test:
        ...
        expected_output = gpd.GeoDataFrame(
            {
                ...
                "Type": ["Spoortak", "Kruisingbeen"],
                "X_BEGIN": [1, 10],
                "Y_BEGIN": [0, 100],
            },
            geometry=[
                LineString([(10, 0), (10, 1), (10, 2)]),
    ...
    def test_prep_spoortaken_gdf_minimal_example_with_one_none(
        self, puic_mapservices
    ):
        spoor_gdf = gpd.GeoDataFrame(
            {
        ...
        expected_output = expected_output[
            ["SPOOR_ID", "SPOOR_PUIC", "geometry", "Type"]
        ]
    ...
    def test_prep_wisselkruisingbeen_gdf_minimal_example_with_both_wisselbeen_and_kruisingbeen(  # noqa: E501
        ...
        wisselkruisingbeen_gdf = gpd.GeoDataFrame(
            {
                ...
                "TYPE_WISSELKRUISINGBEEN": [
                    "Wisselbeen",
                    "Kruisingbeen",
                    "Onbekend",
                ],
                "REF_WISSEL_KRUISING_NAAM": [1, 2, 3],
                "GEOCODE": [123, 456, 789],
            },
            geometry=[Point(1, 2), Point(3, 4), Point(5, 6)],
        )
        ...
        expected_output = gpd.GeoDataFrame(
            {
                "SPOOR_PUIC": [123, 456],
                "Type": ["Wisselbeen", "Kruisingbeen"],
                "REF_WISSEL_KRUISING_NAAM": [1, 2],
                "GEOCODE": [123, 456],
                "SPOOR_ID": ["123_1", "2"],
            },
